...
public static class Indicators
{
    ...
    /// <summary>Executes built-in factors through the shared compiled-plan JSON contract.</summary>
    public static string FactorExecuteJson(string requestJson)
    {
    ...
    /// <summary>Evaluates a Formula independently for each symbol/timeframe frame.</summary>
    public static string FormulaEvalPanelContractJson(string requestJson)
    {
