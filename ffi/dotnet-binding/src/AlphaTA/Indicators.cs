...
{
    private const string LibraryName = "alpha_ta_dotnet";
...
internal static class NativeLibraryResolver
{
    ...
    public static void EnsureLibraryLoaded()
    {
        ...
        var libraryName = OperatingSystem.IsWindows() ? "alpha_ta_dotnet.dll"
                       : OperatingSystem.IsMacOS() ? "libalpha_ta_dotnet.dylib"
