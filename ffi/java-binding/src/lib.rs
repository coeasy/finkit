...
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_factorCatalogJson(
    env: JNIEnv,
    _class: JClass,
) -> jni::sys::jstring {
    ffi_catch_ptr(|| {
        match finkit_ffi_common::factor_catalog::factor_catalog_json()
            .ok()
            .and_then(|json| env.new_string(json).ok())
        {
            Some(value) => value.into_raw(),
...
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_operationExecuteJson(
    mut env: JNIEnv,
    _class: JClass,
    ...
    ffi_catch_ptr(|| {
        ...
        let payload = finkit_ffi_common::execute_operation_json(&request_json);
...
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_compositeStreamExecuteJson(
    mut env: JNIEnv,
    _class: JClass,
    request_json: JString,
) -> jni::sys::jstring {
    ffi_catch_ptr(|| {
        ...
        let payload = finkit_ffi_common::evaluate_composite_stream_json(&request_json)
...
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_factorExecuteJson(
    mut env: JNIEnv,
    _class: JClass,
    request_json: JString,
) -> jni::sys::jstring {
    ffi_catch_ptr(|| {
        ...
        let payload =
            finkit_ffi_common::evaluate_factor_json(&request_json).unwrap_or_else(|error| {
                serde_json::json!({
...
/// JNI bridge for one cross-sectional Factor through the shared JSON contract.
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_factorCrossSectionalExecuteJson(
    mut env: JNIEnv,
    _class: JClass,
    request_json: JString,
) -> jni::sys::jstring {
    ffi_catch_ptr(|| {
        ...
        let payload = finkit_ffi_common::evaluate_factor_cross_sectional_json(&request_json)
            .unwrap_or_else(|error| {
                serde_json::json!({
...
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_factorStreamExecuteJson(
    mut env: JNIEnv,
    _class: JClass,
    request_json: JString,
) -> jni::sys::jstring {
    ffi_catch_ptr(|| {
        ...
        let payload =
            finkit_ffi_common::evaluate_factor_stream_json(&request_json).unwrap_or_else(|error| {
                serde_json::json!({
...
/// JNI bridge for the explicit timestamped Formula contract.
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_formulaEvalTemporalContractJson(
    mut env: JNIEnv,
    _class: JClass,
    request_json: JString,
) -> jni::sys::jstring {
    ffi_catch_ptr(|| {
        ...
        let payload = finkit_ffi_common::evaluate_formula_temporal_json(&request_json)
            .unwrap_or_else(|error| {
                serde_json::json!({
...
/// JNI bridge for the multi-symbol / multi-timeframe Formula contract.
#[no_mangle]
pub extern "system" fn Java_com_finkit_Indicators_formulaEvalPanelContractJson(
    mut env: JNIEnv,
    _class: JClass,
    request_json: JString,
) -> jni::sys::jstring {
    ffi_catch_ptr(|| {
        ...
        let payload =
            finkit_ffi_common::evaluate_formula_panel_json(&request_json).unwrap_or_else(|error| {
                serde_json::json!({
...
pub extern "system" fn Java_com_finkit_Indicators_formulaStreamExecuteJson(
    ...
    ffi_catch_ptr(|| {
        ...
        let payload = finkit_ffi_common::evaluate_formula_stream_json(&request_json)
            .unwrap_or_else(|error| {
                serde_json::json!({
