...
test('exports core indicator and formula entry points', () => {
  for (const name of ['sma', 'ema', 'rsi', 'macd', 'formulaEval', 'formulaEvalContractJson', 'operationCatalogJson', 'factorCatalogJson', 'compositeExecuteJson', 'factorExecuteJson', 'operationExecuteJson', 'formulaValidate', 'formulaAnalyze', 'formulaMetadata', 'formulaCompatibilityReport']) {
