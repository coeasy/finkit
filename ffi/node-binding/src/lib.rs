...
#[napi]
#[cfg(feature = "formula")]
pub fn formula_eval_temporal_contract_json(request_json: String) -> Result<String> {
...
#[napi]
#[cfg(feature = "formula")]
pub fn formula_eval_panel_contract_json(request_json: String) -> Result<String> {
...
#[napi]
pub fn composite_stream_execute_json(request_json: String) -> Result<String> {
