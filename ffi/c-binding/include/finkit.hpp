...
inline std::string operation_execute_json(const std::string& request_json) {
    ...
    if (raw == nullptr) {
        throw TaLibException("operation execution returned null");
    }
    std::string result(raw);
    finkit_free_string(raw);
    return result;
...
inline std::string composite_execute_json(const std::string& request_json) {
    char* raw = ta_composite_execute_json(request_json.c_str());
    if (raw == nullptr) {
        throw TaLibException("composite execution returned null");
    }
    std::string result(raw);
    finkit_free_string(raw);
    return result;
...
inline std::string factor_cross_sectional_execute_json(const std::string& request_json) {
    char* raw = ta_factor_cross_sectional_execute_json(request_json.c_str());
    if (raw == nullptr) {
        throw TaLibException("cross-sectional factor execution returned null");
    }
    std::string result(raw);
    finkit_free_string(raw);
    return result;
...
inline std::string formula_eval_panel_contract_json(const std::string& request_json) {
    char* raw = ta_formula_eval_panel_contract_json(request_json.c_str());
    if (raw == nullptr) {
        throw TaLibException("formula panel contract returned null");
    }
    std::string result(raw);
    finkit_free_string(raw);
    return result;
...
inline std::string formula_eval_cross_sectional_contract_json(const std::string& request_json) {
    char* raw = ta_formula_eval_cross_sectional_contract_json(request_json.c_str());
    if (raw == nullptr) {
        throw TaLibException("cross-sectional formula contract returned null");
    }
    std::string result(raw);
    finkit_free_string(raw);
    return result;
...
inline std::string formula_stream_execute_json(const std::string& request_json) {
    char* raw = ta_formula_stream_execute_json(request_json.c_str());
    if (raw == nullptr) {
        throw TaLibException("formula stream execution returned null");
    }
    std::string result(raw);
    finkit_free_string(raw);
    return result;
