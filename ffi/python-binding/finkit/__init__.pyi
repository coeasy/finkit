...
def factor_catalog_json() -> str:
    """Return the versioned built-in Factor metadata catalog as JSON."""
    ...

def operation_execute_json(request_json: str) -> str:
...
def factor_execute_json(request_json: str) -> str:
...
def formula_eval_contract_json(
    source: str,
    dialect: str,
    open: ArrayLike,
    high: ArrayLike,
...
__all__ = [
    ...
    "operation_catalog_json", "factor_catalog_json", "operation_execute_json", "composite_execute_json", "factor_execute_json", "formula_eval_contract_json",
    # Visualization
