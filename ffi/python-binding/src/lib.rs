...
/// Evaluate a timestamped Formula request through the shared temporal contract.
#[pyfunction]
#[cfg(feature = "formula")]
...
/// Evaluate one Formula independently for each explicit symbol/timeframe frame.
#[pyfunction]
#[cfg(feature = "formula")]
