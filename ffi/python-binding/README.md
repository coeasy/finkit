...
This directory contains the Python package and PyO3 native extension for Finkit `v0.1.6`.

## Current release status

The GitHub `v0.1.6` Release contains verified CPython ABI3 wheels for:
