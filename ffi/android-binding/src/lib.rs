...
fn dispatch_ta(name: &str, data: &[f64], period: usize) -> Vec<f64> {
    let res: Option<Result<ndarray::Array1<f64>, _>> = match name {
        "ta_sma" => Some(alpha_ta_core::math::moving_avg::sma(data, period)),
        "ta_ema" => Some(alpha_ta_core::math::moving_avg::ema(data, period)),
        "ta_wma" => Some(alpha_ta_core::math::moving_avg::wma(data, period)),
        "ta_dema" => Some(alpha_ta_core::math::moving_avg::dema(data, period)),
        "ta_tema" => Some(alpha_ta_core::math::moving_avg::tema(data, period)),
        "ta_rsi" => Some(alpha_ta_core::indicators::momentum::rsi(data, period)),
        "ta_mom" => Some(alpha_ta_core::indicators::momentum::mom(data, period)),
        "ta_roc" => Some(alpha_ta_core::indicators::momentum::roc(data, period)),
        "ta_cmo" => Some(alpha_ta_core::indicators::momentum::cmo(data, period)),
        "ta_trix" => Some(alpha_ta_core::indicators::momentum::trix(data, period)),
        "ta_midpoint" => Some(alpha_ta_core::indicators::overlap::midpoint(data, period)),
        "ta_zscore" => Some(alpha_ta_core::indicators::statistics::zscore(data, period)),
        "ta_tsf" => Some(alpha_ta_core::indicators::statistics::tsf(data, period)),
        "ta_linear_reg" => Some(alpha_ta_core::indicators::statistics::linearreg(data, period)),
        "ta_percent_rank" => Some(alpha_ta_core::indicators::statistics::percent_rank(data, period)),
        _ => None,
    };
