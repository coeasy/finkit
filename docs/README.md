...
This directory is the canonical documentation set for the current Finkit codebase and the `v0.1.5` release contract. It distinguishes source builds, CI candidates, GitHub Release assets, and public registry packages.
...
8. [Screening formulas](screening-formulas.md) — cross-market signals and selection recipes.

## v0.1.5 release and multi-language packages

The `v0.1.5` tag is the versioned source contract. The release workflow builds and verifies:

- Python ABI3 wheels and Rust/CLI assets;
- Node.js platform packages and Java/JNI JAR;
- C/C++ SDK, Go/CGO module archive, .NET NuGet package, and WASM bundles;
- Android AAR and iOS XCFramework candidates;
- per-artifact checksums generated by the release workflow.

The presence of a GitHub Release asset does not imply publication to PyPI,
crates.io, npm, Maven Central, NuGet, a public Go module, Android Maven, or
Swift Package Manager. Those registries require their own clean-install gate.
...
| [screening-formulas.md](screening-formulas.md) | Cross-market screening API and recipes |
...
| [release-v0.1.5.md](release-v0.1.5.md) | v0.1.5 package matrix and release checklist |
...
_Last reviewed for the `v0.1.5` release contract: 2026-09-09._
