...
- `operation_execute_json` 已支持显式 `semantic_profile=core_registry` 与 `semantic_profile=talib_0_7_1`；后者目前覆盖 MA、SMA/EMA/WMA/DEMA/TEMA/TRIMA/T3/KAMA、MAMA/MAVP/SAREXT、ACCBANDS/AVGDEV/IMI、HT_DCPERIOD/HT_DCPHASE/HT_PHASOR/HT_SINE/HT_TRENDMODE/HT_TRENDLINE、常见 CDLDOJI/CDLDRAGONFLYDOJI/CDLGRAVESTONEDOJI/CDLENGULFING/CDLHAMMER/CDLHANGINGMAN/CDLHARAMI/CDLMARUBOZU/CDLPIERCING/CDLSHOOTINGSTAR/CDLSPINNINGTOP、RSI/CMO、MACD/MACDEXT/MACDFIX、BBANDS、ATR/NATR/TRANGE、ADX/ADXR/DX/+DI/-DI、CCI、AROON/AROONOSC、APO/BOP/TRIX、STOCH/STOCHF/STOCHRSI、WILLR、MOM/ROC/ROCP/ROCR/ROCR100、OBV、MFI、AVGPRICE/MEDPRICE/TYPPRICE/WCLPRICE、MIDPOINT/MIDPRICE、SAR，以及 AD/ADOSC、PLUS_DM/MINUS_DM、PPO/ULTOSC、BETA/CORREL、LINEARREG 系列/TSF/STDDEV/VAR、ADD/SUB/MULT/DIV/MAX/MIN/MAXINDEX/MININDEX/SUM 和常见逐元素 Math Transform。其余 TA-Lib catalog 仍返回结构化 `unsupported_operation`。TA-Lib 与国内终端同名函数必须继续在 variant/profile registry 中显式区分，禁止把同名 `SMA` 等语义静默合并。
