    ...
    ($name:ident, $core:ty, $doc:expr) => {
        ...
        impl $name {
            ...
            pub fn reset(&mut self) {
                StreamingIndicator::reset(&mut self.inner);
            }
            #[wasm_bindgen(js_name = "isReady")]
            pub fn is_ready(&self) -> bool {
                StreamingIndicator::is_ready(&self.inner)
            }
            pub fn count(&self) -> usize {
                StreamingIndicator::count(&self.inner)
            }
        }
    };
}
...
wasm_streaming_f64!(
    WasmStreamingMcGinley,
    StreamingMcGinley,
    "Streaming McGinley Dynamic"
);
wasm_streaming_f64!(
    WasmStreamingEfficiencyRatio,
    StreamingEfficiencyRatio,
    "Streaming Efficiency Ratio"
);
wasm_streaming_f64!(WasmStreamingTrix, StreamingTrix, "Streaming TRIX");
wasm_streaming_f64!(
    WasmStreamingVolumeMomentum,
    StreamingVolumeMomentum,
    "Streaming Volume Momentum"
);
wasm_streaming_f64!(
    WasmStreamingVolumeRoc,
    StreamingVolumeRoc,
    "Streaming Volume ROC"
);
...
impl WasmStreamingNatr {
    ...
    pub fn new(period: usize) -> Self {
        Self {
            inner: StreamingNatr::new(period),
        }
    }
    pub fn update(&mut self, high: f64, low: f64, close: f64) -> f64 {
...
impl WasmStreamingPpo {
    ...
    pub fn new(fast_period: usize, slow_period: usize) -> Self {
        Self {
            inner: StreamingPpo::new(fast_period, slow_period),
        }
    }
    pub fn update(&mut self, value: f64) -> f64 {
        StreamingIndicator::next(&mut self.inner, value).unwrap_or(f64::NAN)
...
impl WasmStreamingApo {
    ...
    pub fn new(fast_period: usize, slow_period: usize) -> Self {
        Self {
            inner: StreamingApo::new(fast_period, slow_period),
        }
    }
    pub fn update(&mut self, value: f64) -> f64 {
        StreamingIndicator::next(&mut self.inner, value).unwrap_or(f64::NAN)
...
impl WasmStreamingTsi {
    ...
    pub fn new(long_period: usize, short_period: usize) -> Self {
        Self {
            inner: StreamingTsi::new(long_period, short_period),
        }
    }
    pub fn update(&mut self, value: f64) -> f64 {
        StreamingIndicator::next(&mut self.inner, value).unwrap_or(f64::NAN)
...
#[wasm_bindgen]
pub struct WasmStreamingCoppock {
    inner: StreamingCoppock,
}
...
impl WasmStreamingCoppock {
    ...
    pub fn new(wma_period: usize, long_roc: usize, short_roc: usize) -> Self {
        Self {
            inner: StreamingCoppock::new(wma_period, long_roc, short_roc),
        }
    }
    pub fn update(&mut self, value: f64) -> f64 {
        StreamingIndicator::next(&mut self.inner, value).unwrap_or(f64::NAN)
...
pub struct WasmAroonOutput {
    pub aroon_up: f64,
    pub aroon_down: f64,
}

#[wasm_bindgen]
pub struct WasmStreamingAroon {
...
impl WasmStreamingAroon {
    ...
    pub fn update(&mut self, high: f64, low: f64) -> WasmAroonOutput {
        match StreamingIndicator::next(&mut self.inner, (high, low)) {
            Some(out) => WasmAroonOutput {
                aroon_up: out.aroon_up,
                aroon_down: out.aroon_down,
            },
            None => WasmAroonOutput {
                aroon_up: f64::NAN,
                aroon_down: f64::NAN,
            },
        }
...
#[wasm_bindgen]
pub struct WasmStreamingAroonOsc {
    inner: StreamingAroonOsc,
}
...
impl WasmStreamingAroonOsc {
    ...
    pub fn new(period: usize) -> Self {
        Self {
            inner: StreamingAroonOsc::new(period),
        }
    }
...
#[wasm_bindgen(getter_with_clone)]
pub struct WasmSuperTrendOutput {
    pub supertrend: f64,
    pub direction: i32,
}
...
impl WasmStreamingSuperTrend {
    ...
    pub fn update(&mut self, high: f64, low: f64, close: f64) -> WasmSuperTrendOutput {
        ...
        match self.inner.next(&bar) {
            Some(out) => WasmSuperTrendOutput {
                supertrend: out.supertrend,
                direction: out.direction,
            },
            None => WasmSuperTrendOutput {
                supertrend: f64::NAN,
                direction: 0,
            },
        }
...
impl WasmStreamingJma {
    ...
    pub fn new(period: usize, phase: f64, power: f64) -> Self {
        Self {
            inner: StreamingJma::new(period, phase, power),
        }
    }
    pub fn update(&mut self, value: f64) -> f64 {
        StreamingIndicator::next(&mut self.inner, value).unwrap_or(f64::NAN)
...
#[wasm_bindgen]
pub struct WasmStreamingQStick {
    inner: StreamingQStick,
}
...
impl WasmStreamingQStick {
    ...
    pub fn new(period: usize) -> Self {
        Self {
            inner: StreamingQStick::new(period),
        }
    }
...
#[wasm_bindgen(getter_with_clone)]
pub struct WasmKstOutput {
    pub kst: f64,
    pub signal: f64,
}

#[wasm_bindgen]
pub struct WasmStreamingKst {
    inner: StreamingKst,
}
...
impl WasmStreamingKst {
    ...
    pub fn new(
        ...
        Self {
            inner: StreamingKst::new(roc1, roc2, roc3, roc4, sma1, sma2, sma3, sma4, sig_period),
        }
    }
    pub fn update(&mut self, value: f64) -> WasmKstOutput {
        match StreamingIndicator::next(&mut self.inner, value) {
            Some(out) => WasmKstOutput {
                kst: out.kst,
                signal: out.signal,
            },
            None => WasmKstOutput {
...
impl WasmStreamingStc {
    ...
    pub fn new(fast_period: usize, slow_period: usize, cycle: usize) -> Self {
        Self {
            inner: StreamingStc::new(fast_period, slow_period, cycle),
        }
    }
    pub fn update(&mut self, value: f64) -> f64 {
        StreamingIndicator::next(&mut self.inner, value).unwrap_or(f64::NAN)
...
#[wasm_bindgen(getter_with_clone)]
pub struct WasmVortexOutput {
    pub vi_plus: f64,
    pub vi_minus: f64,
}

#[wasm_bindgen]
pub struct WasmStreamingVortex {
    inner: StreamingVortex,
}
...
impl WasmStreamingVortex {
    ...
    pub fn new(period: usize) -> Self {
        Self {
            inner: StreamingVortex::new(period),
        }
    }
    pub fn update(&mut self, high: f64, low: f64, close: f64) -> WasmVortexOutput {
        match StreamingIndicator::next(&mut self.inner, (high, low, close)) {
            Some(out) => WasmVortexOutput {
                vi_plus: out.vi_plus,
                vi_minus: out.vi_minus,
            },
            None => WasmVortexOutput {
                vi_plus: f64::NAN,
                vi_minus: f64::NAN,
            },
        }
...
#[wasm_bindgen]
pub struct WasmStreamingKeltner {
...
impl WasmStreamingKeltner {
    ...
    pub fn update(&mut self, high: f64, low: f64, close: f64) -> WasmKeltnerOutput {
        let bar = OhlcvBar::new(0.0, high, low, close, 0.0);
        match self.inner.next(&bar) {
            Some(out) => WasmKeltnerOutput {
                upper: out.upper,
                middle: out.middle,
                lower: out.lower,
            },
            None => WasmKeltnerOutput {
                upper: f64::NAN,
                middle: f64::NAN,
                lower: f64::NAN,
            },
...
#[wasm_bindgen(getter_with_clone)]
pub struct WasmRviOutput {
    pub rvi: f64,
    pub signal: f64,
}

#[wasm_bindgen]
pub struct WasmStreamingRvi {
    inner: StreamingRvi,
}
...
#[wasm_bindgen]
pub struct WasmStreamingStochRsi {
    inner: StreamingStochRsi,
}
...
impl WasmStreamingStochRsi {
    ...
    pub fn new(rsi_period: usize, stoch_period: usize, k_smooth: usize, d_smooth: usize) -> Self {
        Self {
            inner: StreamingStochRsi::new(rsi_period, stoch_period, k_smooth, d_smooth),
        }
    }
    pub fn update(&mut self, value: f64) -> f64 {
        StreamingIndicator::next(&mut self.inner, value).unwrap_or(f64::NAN)
...
#[wasm_bindgen(getter_with_clone)]
pub struct WasmStochFOutput {
    pub k: f64,
    pub d: f64,
}

#[wasm_bindgen]
pub struct WasmStreamingStochF {
    inner: StreamingStochF,
}
...
#[wasm_bindgen]
pub struct WasmStreamingForceIndex {
    inner: StreamingForceIndex,
}
...
impl WasmStreamingForceIndex {
    ...
    pub fn new(period: usize) -> Self {
        Self {
            inner: StreamingForceIndex::new(period),
        }
    }
    pub fn update(&mut self, close: f64, volume: f64) -> f64 {
        let bar = OhlcvBar::new(0.0, 0.0, 0.0, close, volume);
...
#[wasm_bindgen(getter_with_clone)]
pub struct WasmKvoOutput {
    pub kvo: f64,
    pub signal: f64,
}

#[wasm_bindgen]
pub struct WasmStreamingKvo {
    inner: StreamingKvo,
}
...
impl WasmStreamingKvo {
    ...
    pub fn new(fast_period: usize, slow_period: usize, signal_period: usize) -> Self {
        Self {
            inner: StreamingKvo::new(fast_period, slow_period, signal_period),
        }
    }
    pub fn update(&mut self, high: f64, low: f64, close: f64, volume: f64) -> WasmKvoOutput {
        let bar = OhlcvBar::new(0.0, high, low, close, volume);
        match self.inner.next(&bar) {
            Some(out) => WasmKvoOutput {
                kvo: out.kvo,
                signal: out.signal,
            },
            None => WasmKvoOutput {
...
#[wasm_bindgen]
pub struct WasmStreamingAnchoredVwap {
    inner: StreamingAnchoredVwap,
}
...
impl WasmStreamingAnchoredVwap {
    ...
    pub fn new() -> Self {
        Self {
            inner: StreamingAnchoredVwap::new(),
        }
    }
    pub fn update(&mut self, high: f64, low: f64, close: f64, volume: f64) -> f64 {
        let bar = OhlcvBar::new(0.0, high, low, close, volume);
...
impl WasmStreamingVwma {
    ...
    pub fn new(period: usize) -> Self {
        Self {
            inner: StreamingVwma::new(period),
        }
    }
    pub fn update(&mut self, close: f64, volume: f64) -> f64 {
        let bar = OhlcvBar::new(0.0, 0.0, 0.0, close, volume);
...
#[wasm_bindgen]
pub struct WasmStreamingAvgPrice {
    inner: StreamingAvgPrice,
}
...
#[wasm_bindgen]
pub struct WasmStreamingMedPrice {
    inner: StreamingMedPrice,
}
...
#[wasm_bindgen]
pub struct WasmStreamingTypPrice {
    inner: StreamingTypPrice,
}
...
#[wasm_bindgen]
pub struct WasmStreamingAdosc {
    inner: StreamingAdosc,
}
...
impl WasmStreamingAdosc {
    ...
    pub fn new(fast_period: usize, slow_period: usize) -> Self {
        Self {
            inner: StreamingAdosc::new(fast_period, slow_period),
        }
    }
    pub fn update(&mut self, high: f64, low: f64, close: f64, volume: f64) -> f64 {
        let bar = OhlcvBar::new(0.0, high, low, close, volume);
