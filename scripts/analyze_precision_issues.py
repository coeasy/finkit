...
alpha_ad = np.array(alpha_ta.ad(high, low, close, volume))
...
alpha_result = alpha_ta.aroon(high, low, timeperiod=14)
...
alpha_result = alpha_ta.bollinger_bands(close, timeperiod=20, nbdevup=2.0, nbdevdn=2.0)
