...
def build_report(env: EnvInfo, dry_run: bool = True) -> str:
    ...
    lines = [
        ...
        "### Methodology",
        "",
        "- **AlphaTA**: `cargo bench -p alpha-ta-core --bench competitive_bench`",
        "- **TA-Lib C**: `cargo bench -p alpha-ta-core --bench talib_c_comparison --features talib-c`",
        "- **Kand / ta-rs / quantedge-ta**: `cargo bench -p alpha-ta-core --bench competitive_bench`",
    ...
    lines.extend([
        ...
        "cargo bench -p alpha-ta-core --bench competitive_bench",
        "",
