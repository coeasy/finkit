...
INDICATORS: dict[str, dict[str, Any]] = {
    ...
    "COPPOCK": {
        "params": {"wmaperiod": 10, "roc1period": 11, "roc2period": 14},
        "fn_name": "COPPOCK",
        "inputs": ("close",),
        "outputs": ("coppock",),
    },
    ...
    "SUPERTREND": {
        "params": {"timeperiod": 10, "multiplier": 3.0},
        "fn_name": "SUPERTREND",
        "inputs": ("high", "low", "close"),
        "outputs": ("supertrend", "trend"),
    },
    "TSI": {
        "params": {"firstperiod": 25, "secondperiod": 13},
        "fn_name": "TSI",
        "inputs": ("close",),
        "outputs": ("tsi",),
    },
    ...
    "CVI": {
        "params": {"timeperiod": 10, "rocperiod": 10},
        "fn_name": "CVI",
        "inputs": ("high", "low"),
        "outputs": ("real",),
    },
    ...
    "FRACTAL": {
        "params": {"leftbars": 2, "rightbars": 2},
        "fn_name": "FRACTAL",
        "inputs": ("high", "low"),
        "outputs": ("swinghigh", "swinglow"),
    },
    "KC": {
        "params": {"timeperiod": 20, "atrperiod": 10, "nbdev": 2.0},
        "fn_name": "KC",
        "inputs": ("high", "low", "close"),
        "outputs": ("upperband", "middleband", "lowerband"),
    },
    ...
    "MASSI": {
        "params": {"fastperiod": 9, "slowperiod": 25},
        "fn_name": "MASSI",
        "inputs": ("high", "low"),
        "outputs": ("real",),
    },
    "PERCENTILE": {
        "params": {"timeperiod": 30, "percentile": 50.0},
        "fn_name": "PERCENTILE",
        "inputs": ("close",),
        "outputs": ("real",),
    },
    "PVO": {
        "params": {"fastperiod": 12, "slowperiod": 26, "matype": 1},
        "fn_name": "PVO",
        "inputs": ("volume",),
        "outputs": ("real",),
    },
    ...
    "RVI": {
        "params": {"timeperiod": 14, "stddevperiod": 10},
        "fn_name": "RVI",
        "inputs": ("close",),
        "outputs": ("real",),
    },
