...
fn default_mappings() -> Vec<BuiltinMapping> {
    vec![
        ...
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "wma".to_string(),
            alpha_ta_name: "WMA".to_string(),
            multi_return: false,
            return_names: vec!["WMA".to_string()],
            description: "Weighted Moving Average — ta.wma(source, length) → WMA".to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "hma".to_string(),
            alpha_ta_name: "HMA".to_string(),
            multi_return: false,
            return_names: vec!["HMA".to_string()],
            description: "Hull Moving Average — ta.hma(source, length) → HMA".to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "stdev".to_string(),
            alpha_ta_name: "STDDEV".to_string(),
            multi_return: false,
            return_names: vec!["STDDEV".to_string()],
            description: "Rolling standard deviation — ta.stdev(source, length) → STDDEV"
                .to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "variance".to_string(),
            alpha_ta_name: "VAR".to_string(),
            multi_return: false,
            return_names: vec!["VAR".to_string()],
            description: "Rolling variance — ta.variance(source, length) → VAR".to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "correlation".to_string(),
            alpha_ta_name: "CORREL".to_string(),
            multi_return: false,
            return_names: vec!["CORREL".to_string()],
            description: "Rolling correlation — ta.correlation(source1, source2, length) → CORREL"
                .to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "barssince".to_string(),
            alpha_ta_name: "BARSSINCE".to_string(),
            multi_return: false,
            return_names: vec!["BARSSINCE".to_string()],
            description: "Bars since condition — ta.barssince(condition) → BARSSINCE"
                .to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "tr".to_string(),
            alpha_ta_name: "TRANGE".to_string(),
            multi_return: false,
            return_names: vec!["TRANGE".to_string()],
            description: "True range — ta.tr() → TRANGE".to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "sum".to_string(),
            alpha_ta_name: "SUM".to_string(),
            multi_return: false,
            return_names: vec!["SUM".to_string()],
            description: "Rolling sum — ta.sum(source, length) → SUM".to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "cum".to_string(),
            alpha_ta_name: "CUMSUM".to_string(),
            multi_return: false,
            return_names: vec!["CUMSUM".to_string()],
            description: "Cumulative sum — ta.cum(source) → CUMSUM".to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
            pine_name: "median".to_string(),
            alpha_ta_name: "MEDIAN".to_string(),
            multi_return: false,
            return_names: vec!["MEDIAN".to_string()],
            description: "Rolling median — ta.median(source, length) → MEDIAN".to_string(),
        },
        BuiltinMapping {
            namespace: Some("ta".to_string()),
