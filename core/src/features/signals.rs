...
mod tests {
    ...
    fn test_divergence_basic() {
        let price = vec![
            10.0, 11.0, 12.0, 11.0, 10.0, 9.0, 10.0, 11.0, 13.0, 12.0,
            10.0, 9.0, 10.0, 11.0, 14.0, 13.0, 11.0, 10.0, 9.0, 8.0,
        ];
        let indicator = vec![
            50.0, 55.0, 60.0, 55.0, 50.0, 45.0, 50.0, 55.0, 58.0, 55.0,
            50.0, 45.0, 50.0, 55.0, 56.0, 54.0, 50.0, 48.0, 45.0, 42.0,
        ];
