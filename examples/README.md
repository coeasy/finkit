...
javac -cp dist/java/windows-x64/finkit-0.1.14.jar examples/java_example/FinkitExample.java

# 运行示例
java -cp dist/java/windows-x64/finkit-0.1.14.jar;examples/java_example FinkitExample
```
