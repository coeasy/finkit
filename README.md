...
- Rust package: `finkit-0.1.5.crate` Release asset.
...
| [Screening formulas](docs/screening-formulas.md) | Cross-market signals and selection recipes |
